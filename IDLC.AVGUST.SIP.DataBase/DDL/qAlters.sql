...
ALTER TABLE Composicion ADD idGrupoQuimico integer, ContracionIA varchar(200);
alter TABLE Composicion
ADD FOREIGN KEY (idGrupoQuimico) REFERENCES GrupoQuimico(idGrupoQuimico)
ON DELETE CASCADE 
on UPDATE CASCADE
